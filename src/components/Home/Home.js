  ...
  return (
    <div className={classes["main-content"]}>
      ...
      <div className={classes["homepage-text-container"]}>
        <p>
          Looking to adopt a furry friend? You've come to the right place! With
          over a hundred thousand pets ready for adoption from over ten thousand
          organizations, there's no doubt we'll find the right member to add to
          the family!
        </p>
      </div>
